...
SOURCE_DEFAULTS: dict[str, tuple[str | None, str]] = {
    ...
    "cmu_uro_open_projects": ("cmu", "campus"),
    ...
    "grinnell_research_programs": ("grinnell", "campus"),
    "grinnell_faculty": ("grinnell", "unknown"),
    "colby_research_programs": ("colby", "campus"),
    "colby_faculty": ("colby", "unknown"),
    "hamilton_research_programs": ("hamilton", "campus"),
    "hamilton_faculty": ("hamilton", "unknown"),
    "vassar_research_programs": ("vassar", "campus"),
    "vassar_faculty": ("vassar", "unknown"),
    "smith_research_programs": ("smith", "campus"),
    "smith_faculty": ("smith", "unknown"),
    "wlu_research_programs": ("wlu", "campus"),
    "wlu_faculty": ("wlu", "unknown"),
    "colgate_research_programs": ("colgate", "campus"),
    "colgate_faculty": ("colgate", "unknown"),
    "wesleyan_research_programs": ("wesleyan", "campus"),
    "wesleyan_faculty": ("wesleyan", "unknown"),
    "haverford_research_programs": ("haverford", "campus"),
    "haverford_faculty": ("haverford", "unknown"),
    "bates_research_programs": ("bates", "campus"),
    "bates_faculty": ("bates", "unknown"),
    "barnard_research_programs": ("barnard", "campus"),
    "barnard_faculty": ("barnard", "unknown"),
    "coloradocollege_research_programs": ("coloradocollege", "campus"),
    "coloradocollege_faculty": ("coloradocollege", "unknown"),
    "macalester_research_programs": ("macalester", "campus"),
    "macalester_faculty": ("macalester", "unknown"),
    "kenyon_research_programs": ("kenyon", "campus"),
    "kenyon_faculty": ("kenyon", "unknown"),
    "brynmawr_research_programs": ("brynmawr", "campus"),
    "brynmawr_faculty": ("brynmawr", "unknown"),
    ...
    "swarthmore_faculty": ("swarthmore", "unknown"),
    "pomona_research_programs": ("pomona", "campus"),
    "pomona_faculty": ("pomona", "unknown"),
    "wellesley_research_programs": ("wellesley", "campus"),
    "wellesley_faculty": ("wellesley", "unknown"),
    "bowdoin_research_programs": ("bowdoin", "campus"),
    "bowdoin_faculty": ("bowdoin", "unknown"),
    "carleton_research_programs": ("carleton", "campus"),
    "carleton_faculty": ("carleton", "unknown"),
    "cmc_research_programs": ("cmc", "campus"),
    "cmc_faculty": ("cmc", "unknown"),
    "middlebury_research_programs": ("middlebury", "campus"),
    "middlebury_faculty": ("middlebury", "unknown"),
    "davidson_research_programs": ("davidson", "campus"),
    "davidson_faculty": ("davidson", "unknown"),
