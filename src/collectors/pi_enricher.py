...
SCHOOL_EMAIL_DOMAINS: dict[str, tuple[str, ...]] = {
    ...
    "bates": ("bates.edu",),
    "barnard": ("barnard.edu",),
    "coloradocollege": ("coloradocollege.edu",),
    "macalester": ("macalester.edu",),
    "kenyon": ("kenyon.edu",),
    "brynmawr": ("brynmawr.edu",),
    ...
    "yale": ("yale.edu",),
    "cmu": ("cmu.edu", "andrew.cmu.edu", "cs.cmu.edu"),
    ...
    "vt": ("vt.edu",),
    "tamu": ("tamu.edu", "ag.tamu.edu", "cvm.tamu.edu", "stat.tamu.edu",
             "bio.tamu.edu", "chem.tamu.edu", "physics.tamu.edu", "cse.tamu.edu",
             "civil.tamu.edu", "math.tamu.edu", "geos.tamu.edu"),
    "umd": ("umd.edu",),
    "neu": ("northeastern.edu", "ccs.neu.edu"),
    "sbu": ("stonybrook.edu", "cs.stonybrook.edu", "math.stonybrook.edu"),
    "bu": ("bu.edu",),
    "washu": ("wustl.edu", "washu.edu", "email.wustl.edu"),
    "rutgers": ("rutgers.edu", "physics.rutgers.edu", "stat.rutgers.edu",
                "chem.rutgers.edu", "soe.rutgers.edu", "sebs.rutgers.edu",
                "marine.rutgers.edu", "business.rutgers.edu"),
