...
def _ledger_path() -> Path:
    return _REPO / "data" / "releases" / "CURRENT.json"
...
def check_ledger_currency(sha: str | None) -> dict:
    ...
    it, so it is checked like any other evidence, and refreshed rather than
