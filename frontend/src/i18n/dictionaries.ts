...
export const en = {
  ...
  auth: {
    button: {
      ...
      accountAria: 'Signed in as {email}',
    },
    signIn: {
      title: 'Sign in',
      signedInTitle: 'Your account',
      subtitle: 'Get a magic link by email — no password needed.',
      subtitleAnon: 'Add an email to your data so you can access it from any device. We will email you a one-tap sign-in link.',
      signedInSubtitle: 'You are signed in.',
      signedInAs: 'Signed in as {email}',
      signOut: 'Sign out',
      signOutHint: 'Signing out keeps your data tied to your account; you can sign back in anytime.',
      emailLabel: 'Email',
      sending: 'Sending...',
      submit: 'Email me a sign-in link',
      sentTitle: 'Check your inbox',
      sameBrowserHint: 'Tip: open the link in this same browser so the sign-in completes correctly.',
      privacy: 'We only use your email for the sign-in link. No marketing.',
      privacyAnon: "We won't move you off this device until you click the link in your email.",
...
export const zh = {
  ...
  auth: {
    button: {
      signIn: '登录',
      signInAria: '登录或注册账号',
      accountAria: '已登录：{email}',
    },
    signIn: {
      title: '登录',
      signedInTitle: '我的账号',
      subtitle: '邮箱免密登录——无需密码。',
      subtitleAnon: '把邮箱与本机数据关联，让你在任何设备都能用。我们会发一封一键登录邮件给你。',
      signedInSubtitle: '你已登录。',
      signedInAs: '已登录：{email}',
      signOut: '退出登录',
      signOutHint: '退出不会删除数据，下次再登录就能继续用。',
      emailLabel: '邮箱',
      sending: '发送中...',
      submit: '发送登录链接',
      sentTitle: '请查收邮件',
      sameBrowserHint: '小提示：请在当前这个浏览器里打开邮件链接，登录才能完成。',
      privacy: '我们只在这次发邮件时用你的邮箱。无营销。',
      privacyAnon: '在你点击邮件链接之前，本机数据不会迁出。',
      backHome: '返回首页',
    },
    callback: {
      verifying: '正在登录...',
