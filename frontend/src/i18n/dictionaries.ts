...
export const en = {
  ...
  auth: {
    ...
    callback: {
      ...
      identityTakenBody: 'This Google or Microsoft account is already linked to a different OpportunityEngine account, so it can\'t be attached to your guest session.',
...
export const zh = {
  ...
  auth: {
    ...
    callback: {
      ...
      identityTakenBody: '这个 Google / Microsoft 账号已经关联了另一个 OpportunityEngine 账户，无法再挂到当前的游客会话上。',
