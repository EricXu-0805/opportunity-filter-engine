...
export const en = {
  ...
  coldEmail: {
    ...
    refineFabrication: 'The AI edit tried to add a claim we could not verify from your email, so a safe edit was applied instead.',
...
export const zh = {
  ...
  coldEmail: {
    ...
    refineFabrication: 'AI 改写时想加入无法从你邮件中核实的内容，已改为应用安全编辑。',
