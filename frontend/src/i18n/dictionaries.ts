...
export const en = {
  ...
  fellowships: {
    ...
    subtitle: 'Discover undergraduate fellowships, REUs, and funded summer programs at UIUC and beyond. Filter by year, international friendliness, and college.',
...
export const zh = {
  ...
  fellowships: {
    title: '研究奖学金与暑期项目',
    subtitle: '发现 UIUC 及其他高校的本科生奖学金、REU 和有资助的暑期项目。按年级、国际学生友好度和学院筛选。',
    toMatcher: '改用档案匹配',
