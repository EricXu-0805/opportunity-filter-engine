...
export default function AccountMenu({
  ...
  if (!isPermanent) {
    ...
    return (
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[12px] font-medium text-indigo-700 bg-indigo-50 hover:bg-indigo-100 transition-colors shrink-0"
      >
  ...
  const trigger = isMobile ? (
    ...
    >
      <span className="w-6 h-6 rounded-full bg-indigo-100 text-indigo-700 text-[11px] font-semibold uppercase flex items-center justify-center">
        {firstLetter(email)}
      </span>
    ...
    >
      <span className="w-5 h-5 rounded-full bg-indigo-100 text-indigo-700 text-[10px] font-semibold uppercase flex items-center justify-center">
        {firstLetter(email)}
      </span>
