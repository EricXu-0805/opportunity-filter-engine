...
// ucd is absent on purpose: UC Davis left the supported set on 2026-09-06
// (src/school_scope.py). Its catalog file is kept so re-enabling is one
// line in index.ts, but it must not be offered while unsupported.
const NEW_CATALOG_SLUGS = ['ucb', 'umich', 'gatech', 'utexas', 'ucla', 'uw', 'wisc', 'stanford', 'ucsd', 'uchicago', 'uci', 'ucsb', 'boulder', 'jhu', 'northwestern', 'upenn', 'caltech', 'cornell', 'brown', 'rice', 'vanderbilt', 'dartmouth', 'columbia', 'mit', 'harvard', 'usc', 'umn', 'osu', 'nd', 'rochester', 'uf', 'umass', 'yale', 'vt', 'tamu', 'umd', 'neu', 'sbu', 'bu', 'washu', 'rutgers', 'ncsu', 'psu', 'ucsc', 'arizona', 'ucr', 'asu', 'pitt', 'msu', 'cmu', 'uga', 'casewestern', 'houston', 'iastate', 'indiana', 'miami', 'rpi', 'ucf', 'uconn', 'udel', 'uiowa', 'utah', 'buffalo', 'fsu', 'usf', 'utk', 'clemson', 'colostate', 'oregonstate', 'drexel', 'nyu', 'georgetown', 'emory', 'uva', 'tufts', 'bc', 'stevens', 'njit', 'wpi', 'uky', 'lehigh', 'syracuse', 'cincinnati', 'unl', 'lsu', 'utdallas', 'amherst', 'swarthmore', 'pomona', 'wellesley', 'bowdoin', 'carleton', 'cmc', 'middlebury', 'davidson', 'grinnell', 'colby', 'hamilton', 'vassar', 'smith', 'wlu', 'colgate', 'wesleyan', 'haverford', 'bates', 'barnard', 'coloradocollege', 'macalester', 'kenyon', 'brynmawr'];
