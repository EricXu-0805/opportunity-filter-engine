/*
 * UCLA — undergraduate college/major catalog.
 * Generated 2026-06-12 from the officially-verified research dataset; do not hand-edit.
 * Verified against:
 *   https://admission.ucla.edu/apply/majors
 * Note: Verbatim from the UCLA Undergraduate Admission majors page; BA/BS duplicates merged; the College's four divisions merged under College of Letters and Science; inverted catalog names normalized ('Mathematics, Applied' -> 'Applied Mathematics').
 */
