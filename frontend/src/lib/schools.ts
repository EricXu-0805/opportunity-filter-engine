...
export const SCHOOLS: School[] = [
  ...
  },
  {
    ...
    color: '#57068C',
    location: 'New York, NY',
    coverage: campusCoverage('nyu'),
    catalog: { colleges: 4, majors: 29 },
  },
  {
    slug: 'georgetown',
    ...
    coverage: campusCoverage('georgetown'),
    catalog: { colleges: 5, majors: 36 },
  },
  {
    slug: 'emory',
    domain: 'emory.edu',
    ...
    color: '#012169',
    location: 'Atlanta, GA',
    coverage: campusCoverage('emory'),
    catalog: { colleges: 3, majors: 36 },
  },
  {
    slug: 'uva',
    domain: 'virginia.edu',
  ...
  },
  {
    ...
    color: '#3E8EDE',
    location: 'Medford, MA',
    coverage: campusCoverage('tufts'),
    catalog: { colleges: 3, majors: 43 },
  },
  {
    slug: 'uga',
    domain: 'uga.edu',
