...
export const SCHOOLS: School[] = [
  ...
  },
  {
    ...
    coverage: campusCoverage('casewestern'),
    catalog: { colleges: 4, majors: 39 },
  },
  {
    slug: 'houston',
    ...
    color: '#C8102E',
    location: 'Houston, TX',
    coverage: campusCoverage('houston'),
    catalog: { colleges: 6, majors: 42 },
  },
  {
    slug: 'iastate',
    domain: 'iastate.edu',
    ...
    color: '#C8102E',
    location: 'Ames, IA',
    coverage: campusCoverage('iastate'),
    catalog: { colleges: 6, majors: 51 },
  },
  {
    slug: 'indiana',
    domain: 'indiana.edu',
    ...
    coverage: campusCoverage('indiana'),
    catalog: { colleges: 7, majors: 38 },
  },
  {
    slug: 'miami',
    domain: 'miami.edu',
    ...
    coverage: campusCoverage('miami'),
    catalog: { colleges: 7, majors: 55 },
  },
  {
    slug: 'rpi',
    domain: 'rpi.edu',
    ...
    color: '#D6001C',
    location: 'Troy, NY',
    coverage: campusCoverage('rpi'),
    catalog: { colleges: 5, majors: 42 },
  },
  {
    slug: 'ucf',
    domain: 'ucf.edu',
    ...
    color: '#BA9B37',
    location: 'Orlando, FL',
    coverage: campusCoverage('ucf'),
    catalog: { colleges: 7, majors: 46 },
  },
  {
    slug: 'uconn',
    domain: 'uconn.edu',
    ...
    color: '#000E2F',
    location: 'Storrs, CT',
    coverage: campusCoverage('uconn'),
    catalog: { colleges: 6, majors: 41 },
  },
  {
    slug: 'udel',
    domain: 'udel.edu',
